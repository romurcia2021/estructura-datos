...
public class Requerimiento_3Dao {
    ...
    public ArrayList<Requerimiento_3> requerimiento3() throws SQLException {
        ...
        try {
            ...
            String consulta = "SELECT c.Proveedor, c.Pagado , p.Constructora FROM Compra c INNER JOIN Proyecto p on c.ID_Proyecto = p.ID_Proyecto WHERE c.Proveedor ='JUMBO' AND c.Pagado = 'No' ORDER BY p.Constructora;   ";
